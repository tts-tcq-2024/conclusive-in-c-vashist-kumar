...
**I woluld make use of all the learnings, reducing cyclomatic complexity, keeping the code to be easy to change/refactor, writing the code to be testable, reducing the cognitive complexity in my code, keep the code clean, add the interfaces where ever required, and implement these in my work**
